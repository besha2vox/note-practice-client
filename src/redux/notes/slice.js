...
import { fetchNotes, addNote, removeNote, fetchNoteById } from './operations';
...
const notesSlice = createSlice({
  ...
  extraReducers: builder => {
    ...
    builder
      ...
      .addCase(fetchNoteById.fulfilled, (state, { payload }) => {
        state.currentNote = payload;
        state.error = null;
        state.isLoading = false;
      })
      .addCase(fetchNoteById.rejected, (state, { payload }) => {
        state.error = payload;
        state.isLoading = false;
      });
    ...
    builder
      ...
      .addCase(removeNote.fulfilled, (state, { payload }) => {
        const index = state.items.findIndex(note => note.id === payload.id);
